...
Мастер отрисовывается диалоговыми окнами `dialog`/`whiptail` (как в iRedMail):
...
Интерактивный мастер запрашивает параметры диалоговыми окнами (Enter = значение
по умолчанию, пустой ввод для пароля = автогенерация):
